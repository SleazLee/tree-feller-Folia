...
public class AnvilGUI {
    ...
    public static class Builder {
        ...
        class SchedulerTask implements Executor{
            /**
             * The player who has the GUI open
             */
            public Player player;

            SchedulerTask(Player p){
                this.player = p;
            }

            @Override
            public void execute(@NotNull Runnable command) {
                player.getScheduler().run(plugin, scheduledTask -> command.run(),null);
            }
        }
        /**
        ...
        public AnvilGUI open(Player player) {
            ...
            if (mainThreadExecutor == null) {
                mainThreadExecutor = new SchedulerTask(player);
            }
